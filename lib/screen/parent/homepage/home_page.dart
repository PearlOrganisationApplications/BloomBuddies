...
import 'package:bloom/screen/login/login.dart';
import 'package:bloom/screen/parent/homepage/hire.dart';
...
import 'folders.dart';
import 'my_bloom_buddie.dart';
import 'notification.dart';

class ParentHomePage extends StatefulWidget {
  final currentTab;
  const ParentHomePage({Key? key, int? this.currentTab}) : super(key: key);
...
class _ParentHomePageState extends State<ParentHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
      _index == 0 ? ParentMyAccount() :
      _index == 1 ? Hire() :
      _index == 2 ? ParentChat() :
      _index == 3 ? MyBloomBuddie() :
      _index == 4 ? ParentFolders(): ParentNotificationScreen(),
